...
# Generated: 2026-05-19T16:46:52.402652
# Region: vn
...
pts_21 = [Geom::Point3d.new(origin_x+0, origin_y+0, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 9500)]
f_21 = ents.add_face(pts_21)
f_21.material = mat if f_21
f_21.layer = layers['cols'] if f_21
f_21.pushpull(-9500) if f_21
pts_22 = [Geom::Point3d.new(origin_x+0, origin_y+0, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 9500)]
f_22 = ents.add_face(pts_22)
f_22.material = mat if f_22
f_22.layer = layers['cols'] if f_22
f_22.pushpull(-9500) if f_22
pts_23 = [Geom::Point3d.new(origin_x+0, origin_y+0, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 9500)]
f_23 = ents.add_face(pts_23)
f_23.material = mat if f_23
f_23.layer = layers['cols'] if f_23
f_23.pushpull(-9500) if f_23
pts_24 = [Geom::Point3d.new(origin_x+0, origin_y+0, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 9500)]
f_24 = ents.add_face(pts_24)
f_24.material = mat if f_24
f_24.layer = layers['cols'] if f_24
f_24.pushpull(-9500) if f_24
pts_25 = [Geom::Point3d.new(origin_x+0, origin_y+0, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 8500)]
f_25 = ents.add_face(pts_25)
f_25.material = mat if f_25
f_25.layer = layers['cols'] if f_25
f_25.pushpull(-8500) if f_25
pts_26 = [Geom::Point3d.new(origin_x+0, origin_y+0, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 8500)]
f_26 = ents.add_face(pts_26)
f_26.material = mat if f_26
f_26.layer = layers['cols'] if f_26
f_26.pushpull(-8500) if f_26
pts_27 = [Geom::Point3d.new(origin_x+0, origin_y+0, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 8500)]
f_27 = ents.add_face(pts_27)
f_27.material = mat if f_27
f_27.layer = layers['cols'] if f_27
f_27.pushpull(-8500) if f_27
pts_28 = [Geom::Point3d.new(origin_x+0, origin_y+0, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 0), Geom::Point3d.new(origin_x+300, origin_y+300, 8500)]
f_28 = ents.add_face(pts_28)
f_28.material = mat if f_28
f_28.layer = layers['cols'] if f_28
f_28.pushpull(-8500) if f_28
...
pt1_5 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_5 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_5 = ents.add_cline(pt1_5, pt2_5)
ln_5.layer = layers['beams'] if ln_5
pt1_6 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_6 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_6 = ents.add_cline(pt1_6, pt2_6)
ln_6.layer = layers['beams'] if ln_6
pt1_7 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_7 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_7 = ents.add_cline(pt1_7, pt2_7)
ln_7.layer = layers['beams'] if ln_7
pt1_8 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_8 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_8 = ents.add_cline(pt1_8, pt2_8)
ln_8.layer = layers['beams'] if ln_8
pt1_9 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_9 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_9 = ents.add_cline(pt1_9, pt2_9)
ln_9.layer = layers['beams'] if ln_9
pt1_10 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_10 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_10 = ents.add_cline(pt1_10, pt2_10)
ln_10.layer = layers['beams'] if ln_10
pt1_11 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_11 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_11 = ents.add_cline(pt1_11, pt2_11)
ln_11.layer = layers['beams'] if ln_11
pt1_12 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_12 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_12 = ents.add_cline(pt1_12, pt2_12)
ln_12.layer = layers['beams'] if ln_12
pt1_13 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_13 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_13 = ents.add_cline(pt1_13, pt2_13)
ln_13.layer = layers['beams'] if ln_13
pt1_14 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_14 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_14 = ents.add_cline(pt1_14, pt2_14)
ln_14.layer = layers['beams'] if ln_14
pt1_15 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_15 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_15 = ents.add_cline(pt1_15, pt2_15)
ln_15.layer = layers['beams'] if ln_15
pt1_16 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_16 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_16 = ents.add_cline(pt1_16, pt2_16)
ln_16.layer = layers['beams'] if ln_16
pt1_17 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_17 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_17 = ents.add_cline(pt1_17, pt2_17)
ln_17.layer = layers['beams'] if ln_17
pt1_18 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_18 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_18 = ents.add_cline(pt1_18, pt2_18)
ln_18.layer = layers['beams'] if ln_18
pt1_19 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_19 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_19 = ents.add_cline(pt1_19, pt2_19)
ln_19.layer = layers['beams'] if ln_19
pt1_20 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_20 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_20 = ents.add_cline(pt1_20, pt2_20)
ln_20.layer = layers['beams'] if ln_20
pt1_21 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_21 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_21 = ents.add_cline(pt1_21, pt2_21)
ln_21.layer = layers['beams'] if ln_21
pt1_22 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_22 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_22 = ents.add_cline(pt1_22, pt2_22)
ln_22.layer = layers['beams'] if ln_22
pt1_23 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_23 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_23 = ents.add_cline(pt1_23, pt2_23)
ln_23.layer = layers['beams'] if ln_23
pt1_24 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_24 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_24 = ents.add_cline(pt1_24, pt2_24)
ln_24.layer = layers['beams'] if ln_24
pt1_25 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_25 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_25 = ents.add_cline(pt1_25, pt2_25)
ln_25.layer = layers['beams'] if ln_25
pt1_26 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_26 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_26 = ents.add_cline(pt1_26, pt2_26)
ln_26.layer = layers['beams'] if ln_26
pt1_27 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_27 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_27 = ents.add_cline(pt1_27, pt2_27)
ln_27.layer = layers['beams'] if ln_27
pt1_28 = Geom::Point3d.new(origin_x+0, origin_y+0, 3500)
pt2_28 = Geom::Point3d.new(origin_x+4000, origin_y+0, 3500)
ln_28 = ents.add_cline(pt1_28, pt2_28)
ln_28.layer = layers['beams'] if ln_28
...
UI.messagebox('Done: 29c 29b 3s 20w 0f')